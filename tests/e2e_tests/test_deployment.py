...
def test_deployment(tmp_project, cli_options, request):
    """Test the full, live deployment process to Coolify Self-hosted."""

    # Cache the platform name for teardown work.
    request.config.cache.set("platform", "dsd_coolify")

    print("\nTesting deployment to Coolify Self-hosted using the following options:")
